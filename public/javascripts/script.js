    ...
    const assets = {}
    assets.player = new Image(); assets.player.src = '/images/Girl_sprite.png'
//    assets.player = new Image(); assets.player.src = '/images/Demo_sprite2.png'
    assets.shadow = new Image(); assets.shadow.src = '/images/Shadow_sprite.png'
    assets.entity = new Image(); assets.entity.src = '/images/Demo_sprite.webp'
//    assets.map    = new Image(); assets.map.src    = '/images/Demo_map.webp'
    assets.map    = new Image(); assets.map.src    = '/images/carte1.png'
